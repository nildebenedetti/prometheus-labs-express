...
( 1, 'Unlimited Teleportation',                                              'physical, mobility, premium'),
( 2, 'Telepathy',                                                            'psychic, cognitive, communication, premium'),
( 3, 'Technokinesis',                                                        'psychic, technology, cognitive, premium'),
( 4, 'Creates a Sentient Clone',                                             'psychic, identity, premium'),
( 5, 'Eternal Youth',                                                        'physical, anti-aging, longevity, premium'),
( 6, 'X-Ray Vision',                                                         'physical, vision, perception'),
( 7, 'Intentional Invisibility',                                             'physical, stealth'),
( 8, 'Super Strength',                                                       'physical, strength, performance'),
( 9, 'Flight',                                                               'physical, mobility, flight'),
(10, 'Night Consciousness',                                                  'psychic, sleep, cognitive'),
(11, 'Super Endurance',                                                      'physical, endurance, performance'),
(12, 'Rubber Body',                                                          'physical, flexibility, resilience'),
(13, 'Short-Range Telekinesis',                                              'psychic, telekinesis, cognitive'),
(14, 'Subtle Body Manipulation',                                             'psychic, appearance, beauty'),
(15, 'Enhanced Communication with Animals and Low-Intelligence Individuals', 'psychic, communication, animals'),
(16, 'Camouflage',                                                           'physical, stealth, camouflage'),
(17, 'Universal Polyglot',                                                   'psychic, language, communication, cognitive'),
(18, 'Super Focus',                                                          'psychic, focus, cognitive, performance'),
(19, 'Time Dilation',                                                        'psychic, time, cognitive'),
(20, 'Night Vision',                                                         'physical, vision, night'),
(21, 'Holographic Hair',                                                     'physical, appearance, style'),
(22, 'Night Glow',                                                           'physical, appearance, night'),
(23, 'Fire from Your Hands',                                                 'physical, fire, temperature'),
(24, 'Ice from Your Hands',                                                  'physical, ice, temperature'),
(25, 'Super Likability',                                                     'psychic, social, charisma'),
(26, 'Small Animal Transformation',                                          'physical, transformation, fun'),
(27, 'Talk to Plants',                                                       'psychic, nature, communication'),
(28, 'Super Slippery Skin',                                                  'physical, skin, fun'),
(29, 'Super Stickiness',                                                     'physical, skin, fun'),
(30, 'Body Phasing',                                                         'physical, phasing, fun'),
(31, 'Instant Charisma Boost',                                               'psychic, appearance, social'),
(32, 'Instant Alcoholic Beverage',                                           'physical, fun, social'),
(33, 'Zoom Vision',                                                          'physical, eyes'),
(34, 'Super Creative Vision',                                                'psychic, art, creative'),
(35, 'Perfect Singer',                                                       'physical, singing, voice, creative'),
(36, 'Electricity from Your Hands',                                          'physical, electricity, charging'),
(37, 'Gecko Grip',                                                           'physical, climbing, fun'),
(38, 'Short-Term Memory Wipe',                                               'psychic, social, fun'),
(39, 'Perfect Voice Mimicry',                                                'physical, voice, social, fun'),
(40, '8-Bit Visual Aura',                                                    'physical, appearance, fun');
